...
def upgrade() -> None:
    ...
    op.add_column('artist', sa.Column('links', postgresql.ARRAY(sa.String()), nullable=False))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('artwork', sa.Column('festival', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.drop_constraint(None, 'artwork', type_='foreignkey')
    op.drop_constraint(None, 'artwork', type_='foreignkey')
    op.create_foreign_key('artworks_artist_id_fkey', 'artwork', 'user', ['artist_id'], ['id'])
